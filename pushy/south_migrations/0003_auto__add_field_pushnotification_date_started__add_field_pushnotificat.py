...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PushNotification.date_started'
        db.add_column(u'pushy_pushnotification', 'date_started',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PushNotification.date_finished'
        db.add_column(u'pushy_pushnotification', 'date_finished',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PushNotification.date_started'
        db.delete_column(u'pushy_pushnotification', 'date_started')

        # Deleting field 'PushNotification.date_finished'
        db.delete_column(u'pushy_pushnotification', 'date_finished')
