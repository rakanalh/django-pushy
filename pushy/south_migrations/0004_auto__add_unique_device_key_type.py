...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Device', fields ['key', 'type']
        db.create_unique(u'pushy_device', ['key', 'type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Device', fields ['key', 'type']
        db.delete_unique(u'pushy_device', ['key', 'type'])
